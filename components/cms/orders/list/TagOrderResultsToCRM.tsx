...
import {
  useAddCrmTagsToOrderListResultsMutation,
  useAddCrmTagsToOrderListResultsPreviewLazyQuery
} from 'graphql/cms-queries/order-management.generated'

const TagOrderResultsToCRM = () => {
  const { input, count, filters } = useOrdersList()
...
export default TagOrderResultsToCRM
