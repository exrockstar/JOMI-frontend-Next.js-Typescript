...
import { Alert, Box, Grid, InputLabel, MenuItem, Stack } from "@mui/material"
import FormikTextField from "components/common/formik/FormikTextFIeld"
import FormikSelect from "components/common/formik/FormkSelect"
import { Form, Formik } from "formik"
import { PageByIdDocument, PageByIdQuery, useUpdatePageMutation } from "graphql/cms-queries/pages-list.generated"
                ...
                <Grid item xs={12} lg={3} sx={{mr:2}}>
                  <Stack>
                    ...
                    <FormikTextField
                      ...
                      margin="normal"
                    />
                    <Alert severity="info">Used for the URL of the page. E.g., https://dev1.jomi.com/page_slug</Alert>
                    ...
                    <Alert severity="warning">
                      If the password field is provided, a user will be prompted to enter this password when first accessing this page, in their browser.
                    </Alert>
