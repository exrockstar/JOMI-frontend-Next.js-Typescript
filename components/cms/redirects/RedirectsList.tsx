...
import { TableContainer, Card, TableBody, TableCell, TablePagination, Table, Button } from "@mui/material";
import { StyledTableRow } from "components/common/StyledTableRow";
import { RedirectsListQuery, useDeleteRedirectMutation } from "graphql/cms-queries/redirects-list.generated";
                    ...
                    {redirects?.map((redir) => {
                        return(
                            <StyledTableRow key={redir.from}>
                                ...
                                {redir.author ? 
                                    <TableCell>{redir.author.name.first} {redir.author.name.last}</TableCell> 
