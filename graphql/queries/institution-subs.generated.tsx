...
export type InstitutionSubsQuery = { __typename?: 'Query', institution_subs: Array<{ __typename?: 'Institution', _id: string, category?: string | null, name: string, displayName?: string | null }> };
