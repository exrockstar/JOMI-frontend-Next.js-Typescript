...
export type AuthorsQuery = { __typename?: 'Query', authors: Array<{ __typename?: 'Author', _id: string, display_name?: string | null, slug?: string | null, image?: { __typename?: 'Image', filename?: string | null } | null }> };
