...
const pageView = (page: string) => {
  ...
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
    : ''
  const anon_link_id = isClient
    ? localStorage.getItem('anon_link_id') ?? ''
    : ''
...
const trackCreateAccount = (eventParams: CreateAccountParams) => {
  const isClient = typeof window !== 'undefined'
  const referredFrom = isClient ? localStorage.getItem('referrer') ?? '' : ''
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
...
const trackRenewal = (eventParams: RenewalParams) => {
  const isClient = typeof window !== 'undefined'
  const referredFrom = isClient ? localStorage.getItem('referrer') ?? '' : ''
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
...
const trackFeedback = (eventParams: FeedbackParams) => {
  const isClient = typeof window !== 'undefined'
  const referredFrom = isClient ? localStorage.getItem('referrer') ?? '' : ''
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
...
const trackShowFeedback = (eventParams: ShowFeedbackParams) => {
  const isClient = typeof window !== 'undefined'
  const referredFrom = isClient ? localStorage.getItem('referrer') ?? '' : ''
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
...
const trackInitPurchaseArticle = (eventParams: InitPPAParams) => {
  const isClient = typeof window !== 'undefined'
  const referredFrom = isClient ? localStorage.getItem('referrer') ?? '' : ''
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
...
const trackInitRentArticle = (eventParams: InitPPAParams) => {
  const isClient = typeof window !== 'undefined'
  const referredFrom = isClient ? localStorage.getItem('referrer') ?? '' : ''
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
...
const trackRequestSubscription = (eventParams: RequestSubscriptionParams) => {
  const isClient = typeof window !== 'undefined'
  const referredFrom = isClient ? localStorage.getItem('referrer') ?? '' : ''
  const referrerPath = isClient
    ? localStorage.getItem('referrerPath') ?? ''
